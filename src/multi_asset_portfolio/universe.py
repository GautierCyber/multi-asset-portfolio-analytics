...
ASSET_UNIVERSE: dict[str, AssetSpec] = {
    ...
    "GOLD": AssetSpec(
        ...
        benchmark="Gold spot price per gram",
        exchange="Xetra",
        listing_currency="EUR",
        fund_base_currency="N/A",
        income_policy="N/A",
        fx_hedged=False,
        economic_currency_exposure="Gold price in EUR / global gold market",
        xetra_listing_date="2007-12-14",
    ),
    "BROAD_COMMODITIES": AssetSpec(
        ...
        instrument_type="ETF",
        asset_class="Commodity",
        exposure="Diversified Commodity Futures via Total Return Swap",
        benchmark="Bloomberg Commodity Euro Total Return Index",
        exchange="Xetra",
        listing_currency="EUR",
        fund_base_currency="EUR",
        income_policy="N/A",
        fx_hedged=False,
        economic_currency_exposure=(
            "Diversified global commodities with EUR currency conversion"
        ),
        xetra_listing_date="2007-08-21",
    ),
}
